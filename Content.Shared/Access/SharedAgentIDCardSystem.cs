...
namespace Content.Shared.Access.Systems
{
    ...
    public sealed class AgentIDCardBoundUserInterfaceState : BoundUserInterfaceState
    {
        ...
        public uint? CurrentNumber { get; } // Emberfall

        public AgentIDCardBoundUserInterfaceState(string currentName, string currentJob, string currentJobIconId, uint? currentNumber = null) // Emberfall - Added currentNumber
        {
            CurrentName = currentName;
            CurrentJob = currentJob;
            CurrentJobIconId = currentJobIconId;
            CurrentNumber = currentNumber; // Emberfall
        }
    }

    // Emberfall - Add number change message
    [Serializable, NetSerializable]
