...
public sealed partial class ArmorComponent : Component
{
    ...
    /// <summary>
    /// Emberfall: The incoming stamina projectile damage will get multiplied by this value.
    /// </summary>
    [DataField]
    public float StaminaDamageCoefficient = 1;

    /// <summary>
    /// Emberfall: The configured stamina melee damage coefficient. The actual value used
    ...
    /// <summary>
    /// Emberfall: Gets or sets the effective stamina melee damage coefficient, using either the configured
