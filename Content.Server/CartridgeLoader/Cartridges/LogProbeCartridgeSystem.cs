...
public sealed partial class LogProbeCartridgeSystem : EntitySystem // Emberfall - Made partial
{
    ...
    private void AfterInteract(Entity<LogProbeCartridgeComponent> ent, ref CartridgeAfterInteractEvent args)
    {
        ...
        // Emberfall begin - Add NanoChat card scanning
        ...
        ent.Comp.ScannedNanoChatData = null; // Emberfall - Clear any previous NanoChat data
    ...
    private void UpdateUiState(Entity<LogProbeCartridgeComponent> ent, EntityUid loaderUid)
    {
        var state = new LogProbeUiState(ent.Comp.PulledAccessLogs,
            ent.Comp.ScannedNanoChatData); // Emberfall - NanoChat support
